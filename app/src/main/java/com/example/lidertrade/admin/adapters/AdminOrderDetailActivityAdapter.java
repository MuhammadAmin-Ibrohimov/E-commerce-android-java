...
public class AdminOrderDetailActivityAdapter extends RecyclerView.Adapter<AdminOrderDetailActivityAdapter.ViewHolder> {
    private ArrayList<AdminSoldProductModel> dataModalArrayList;
    private Context context;
    FirebaseFirestore db;

    // constructor class for our Adapter
    public AdminOrderDetailActivityAdapter(ArrayList<AdminSoldProductModel> dataModalArrayList, Context context) {
        this.dataModalArrayList = dataModalArrayList;
        this.context = context;
    }
    public AdminOrderDetailActivityAdapter() {
    }


    @NonNull
    @Override
    public AdminOrderDetailActivityAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdminOrderDetailActivityAdapter.ViewHolder holder, int position) {
