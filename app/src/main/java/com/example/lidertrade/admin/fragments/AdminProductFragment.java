...
public class AdminProductFragment extends Fragment {
    ...
    AdminProductFragmentAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.bran));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.category));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.brand));

        viewPager2 = (ViewPager2) v.findViewById(R.id.viewPager);
        adapter = new AdminProductFragmentAdapter(requireActivity());
