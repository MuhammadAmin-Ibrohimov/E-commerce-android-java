...
public class SHFAllProductsAdapter extends RecyclerView.Adapter<SHFAllProductsAdapter.ViewHolder> {
    private ArrayList<AdminProductModel> dataModalArrayList;
    private Context context;


    // constructor class for our Adapter
    public SHFAllProductsAdapter(ArrayList<AdminProductModel> dataModalArrayList, Context context) {
        this.dataModalArrayList = dataModalArrayList;
        this.context = context;
    }

    public SHFAllProductsAdapter() {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.seller_home_fragment_all_products_item, parent, false));
    }
...
//                db = FirebaseFirestore.getInstance();
            ...
            if (sPLAIQDNumberPicker != null) {
                ...
                sPLAIQDNumberPicker.setMaxValue(modal.getProductQuantity());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private CardView productListCardView, sPLAIQuantityCard, sPLAddTheCartCard;
