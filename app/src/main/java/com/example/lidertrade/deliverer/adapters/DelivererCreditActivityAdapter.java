...
public class DelivererCreditActivityAdapter extends RecyclerView.Adapter<DelivererCreditActivityAdapter.ViewHolder> {
    private ArrayList<SellerCreditProductsModel> dataModalArrayList;
    private Context context;
    FirebaseFirestore db;

    // constructor class for our Adapter
    public DelivererCreditActivityAdapter(ArrayList<SellerCreditProductsModel> dataModalArrayList, Context context) {
        this.dataModalArrayList = dataModalArrayList;
        this.context = context;
    }
    public DelivererCreditActivityAdapter() {
    }


    @NonNull
    @Override
    public DelivererCreditActivityAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DelivererCreditActivityAdapter.ViewHolder holder, int position) {
        // setting data to our views in Recycler view items.
        SellerCreditProductsModel modal = dataModalArrayList.get(position);
        db = FirebaseFirestore.getInstance();
        holder.orderSendingDetailProductName.setText(modal.getProductName());
        holder.orderSendingDetailProductQuantity.setText(String.valueOf(modal.getCreditProductQuantity())+" dona");
